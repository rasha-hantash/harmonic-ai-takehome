...
// todo have option to like / unlike companies 
// todo have option to generically add / unadd to a collection 
export async function updateLikedCollection(companyIds: number[]): Promise<void> {
    try {
        const response = await axios.put(`${BASE_URL}/collections/updateLiked`, {
            companyIds,
        });
        console.log('Response from updateLikedCollection:', response.data);
    } catch (error) {
