...
const navigation = [
  ...
  { name: 'Companies', href: '/companies', icon: BuildingOffice2Icon, current: true },
  { name: 'People', href: '/people', icon: UserCircleIcon, current: false },
  { name: 'Searches', href: '/searches', icon: DocumentMagnifyingGlassIcon, current: false },
  { name: 'Lists', href: '/lists', icon: ClipboardDocumentListIcon, current: false },
]
const favorites = [
      ...
      <div>
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2">
                ...
                <nav className="flex flex-1 flex-col">
                  <ul role="list" className="flex flex-1 flex-col gap-y-7">
                    ...
                    <li>
                      <div className="text-xs font-semibold leading-6 text-gray-400">Favorites</div>
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li>
                <div className="flex text-xs font-semibold leading-6 text-gray-400">Favorites</div>
                  <ul role="list" className="-mx-2 mt-2 space-y-1">
                    {favorites.map((favorite) => (
                      <li key={favorite.name}>
                        <a
        ...
        <div className="sticky top-0 z-40 flex items-center justify-between bg-white px-4 py-4 shadow-sm sm:px-6 lg:hidden">
            <div className="flex items-center">
                <button type="button" onClick={() => setSidebarOpen(true)} className="bg-white -m-2.5 p-2.5 text-black-700 lg:hidden">
                <span className="bg-white sr-only">Open sidebar</span>
                <Bars3Icon aria-hidden="true" className="text-black h-6 w-6" />
                </button>
                <div className="text-sm font-semibold leading-6 text-gray-900 ml-4">Dashboard</div>
            </div>
